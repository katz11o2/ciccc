...
function _page($$payload) {
  const images = [
    ...
    "https://i.postimg.cc/Yq4GMgvj/Whats-App-Image-2025-04-24-at-13-14-28-f5789805.jpg"
  ];
  const each_array = ensure_array_like(images);
  $$payload.out += `<div class="page svelte-f4mtfi"><div class="greeting svelte-f4mtfi"><div class="header svelte-f4mtfi"><h2 class="svelte-f4mtfi">Seminar Hall 2</h2> <div class="flex items-center gap-3 mt-2 mb-1 svelte-f4mtfi"><span class="w-2 h-2 bg-blue-900 rounded-full svelte-f4mtfi"></span> <span class="w-2 h-2 bg-blue-900 rounded-full svelte-f4mtfi"></span> <div class="w-[150px] h-0.5 bg-blue-900 ml-2 svelte-f4mtfi"></div></div></div></div> <div class="image-grid svelte-f4mtfi"><!--[-->`;
...
//# sourceMappingURL=_page.svelte-BedCf6SN.js.map
